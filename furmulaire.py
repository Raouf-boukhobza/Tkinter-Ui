...
create_lable(window=inputs_frame).grid(row = 0 , column =0 , columnspan =2, pady = (10 , 20) ,padx = (0 , 100) )
...
button = ctk.CTkButton(master=inputs_frame , fg_color="#5D3FD3" , command= insert_data , text="Submit" , height=40,width=200)
